export function GoogleBtn({ onClick, label }) {
  return (
    <button onClick={onClick} type="button" data-testid="google-login-btn"
      className="w-full flex items-center justify-center gap-3 border border-white/15 rounded-full py-3 font-semibold text-slate-100 hover:border-emerald/50 transition-colors">
